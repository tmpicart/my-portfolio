...
const glassCardVariants = {
  ...
  // caller's p-8 depending on stylesheet order. No CSS transition either:
  // the hover is framer-driven (spotlightHover in lib/motion.ts), and a
  // transition on the same properties would fight the spring.
  spotlight:
